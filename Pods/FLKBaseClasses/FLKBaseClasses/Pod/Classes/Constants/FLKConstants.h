...
#ifndef FLKConstants_h
#define FLKConstants_h
...
static unsigned int PB_NAVIBAR_TINT_HEX                 =       0x6D6D6D;
static NSString * PB_NAVIBAR_TINT_STRING                =       @"#6D6D6D";
